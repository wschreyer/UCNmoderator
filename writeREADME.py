...
surfs = readResults.ReadSurfaces(open(outfile))
cells = readResults.ReadCells(open(outfile))
...
print_prompt_heat(tallies_file, readResults.Graphitecell, 'Graphite')
print_delayed_heat(tallies_file, readResults.Graphitecell, 'Graphite')
