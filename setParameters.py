...
def SetParameters(lead, d2othickness, ld2offset, ld2thickness, ld2length, hepos, heradius, helength, heoffset, inpfile, mcnpfile):
  ...
  d2oy = ld2pos - ld2length - ld2radius - 8.46 - 10
  ...
  SetSize('d2oibott', 61, 'RCC', [1,2,4,6], [ld2pos, ld2z, -ld2length, ld2radius + 7.86], inpfile, mcnpfile)
  SetSize('ld2oi',    62, 'RCC', [1,2,4,6], [ld2pos, ld2z, -ld2length, ld2radius + 8.16], inpfile, mcnpfile)
  ...
  SetSize('thshldi',  89, 'RCC', [1,2,4,6], [ld2pos, ld2z, -ld2length, ld2radius + 2.26], inpfile, mcnpfile)
  SetSize('thshldo',  90, 'RCC', [1,2,4,6], [ld2pos, ld2z, -ld2length, ld2radius + 2.41], inpfile, mcnpfile)
  SetSize('thshldui', 91, 'SPH', [1,2,3], [ld2pos - ld2length, ld2z, ld2radius + 2.26], inpfile, mcnpfile)
  SetSize('thshlduo', 92, 'SPH', [1,2,3], [ld2pos - ld2length, ld2z, ld2radius + 2.41], inpfile, mcnpfile)
  SetSize('vactnki',  93, 'RCC', [1,2,4,6], [ld2pos, ld2z, -ld2length, ld2radius + 6.2], inpfile, mcnpfile)
  SetSize('vactnko',  94, 'RCC', [1,2,4,6], [ld2pos, ld2z, -ld2length, ld2radius + 6.56], inpfile, mcnpfile)
  SetSize('vactnkui', 95, 'SPH', [1,2,3], [ld2pos - ld2length, ld2z, ld2radius + 6.2], inpfile, mcnpfile)
  SetSize('vactnkuo', 96, 'SPH', [1,2,3], [ld2pos - ld2length, ld2z, ld2radius + 6.56], inpfile, mcnpfile)
  SetSize('d2oiup',   97, 'SPH', [1,2,3], [ld2pos - ld2length, ld2z, ld2radius + 8.16], inpfile, mcnpfile)
  SetSize('d2oiboui', 98, 'SPH', [1,2,3], [ld2pos - ld2length, ld2z, ld2radius + 7.86], inpfile, mcnpfile)
  ...
  SetSize('hvactnko',103, 'RCC', [1,2], [ld2pos - ld2length, guidez + 5.], inpfile, mcnpfile)
  SetSize('hvactnki',104, 'RCC', [1,2], [ld2pos - ld2length, guidez + 5.], inpfile, mcnpfile)
  ...
  SetSize('hthshldo',107, 'RCC', [1,2], [ld2pos - ld2length, guidez + 5.], inpfile, mcnpfile)
  SetSize('hthshldi',108, 'RCC', [1,2], [ld2pos - ld2length, guidez + 5.], inpfile, mcnpfile)
  SetSize('hd2obott',109, 'RCC', [1,2,4], [ld2pos - ld2length, guidez + 5., d2oy - (ld2pos - ld2length) - 0.3], inpfile, mcnpfile)
  SetSize('hd2oi',   110, 'RCC', [1,2,4], [ld2pos - ld2length, guidez + 5., d2oy - (ld2pos - ld2length) - 0.3], inpfile, mcnpfile)
