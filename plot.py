...
cspec = ROOT.TCanvas("cgraph", "cgraph", 800, 600)
cspec.SetLogx()
cspec.SetLogy()
hist = tallies.Get('tally4_cell16').ProjectionX()
hist.Scale(6.2415e12/1192100)
hist.GetXaxis().SetTitle('Energy (MeV)')
hist.GetYaxis().SetTitle('Average neutron flux in graphite (cm^{-2} s^{-1} #muA^{-1})')
hist.SetStats(0)
#hist.GetYaxis().SetRangeUser(1e5, 3e9)
hist.Draw('')
cspec.Print('graphitespectrum.pdf')
cspec.Print('graphitespectrum.C')
