...
def calcPQ(p, *args):
#  LD2thickness = setParameters.LD2thickness(p[2],p[3],p[4],p[5],50000)
  setParameters.SetParameters(p[0], p[1], p[2], p[3], p[4], p[5], 14.7, 10.8, p[6])
...
#  print('LD2 thickness: {0}'.format(LD2thickness), file = pfile)
  ...
  print('LD2 volume: {0}'.format(setParameters.LD2volume(p[2], p[3], p[4], p[5], 14.7)), file = pfile)
